...
private:
  ...
  sensor_msgs::ImageConstPtr makeColorImage(const std_msgs::Header& header,
  ...
  image_transport::Publisher snr_image_publisher_;
  ...
  std::unique_ptr<Capture3DConfigController> capture_settings_controller_;
  std::unique_ptr<Capture2DConfigController> capture_2d_config_controller_;
